...
def load_dataset(path: str) -> xr.Dataset:
    ...
    trop_2_ds = trop_2_ds.rename_vars(dict(trpp="ttrp", gh="htrp"))
    print("trop_2_ds before", trop_2_ds)
    
# trpp: some files have it, some dont
    try:
       trop_2_ds = trop_2_ds.rename_vars(dict(t="t1"))
    except Exception:
       trop_2_ds = trop_2_ds.rename_vars(dict(tsfc="t2"))
